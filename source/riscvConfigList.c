...
static const riscvConfig configList[] = {
    ...
    //
    {
        ...
        .bitmanip_absent     = RVBS_1_0_0,    // Default, All Absent
     ...
     */
    {
        ...
        .restrictionsCB      = restrictCV32E40S,
        OPENHW_EXTENSION(OHWF_PMA16|OHWF_SEC|OHWF_BUS_FAULT|OHWF_PARITY_FAULT, OHRV_DEV),
     ...
     *
     * WARL, any illegal value is ignored, original is preserved
     *
     * mtvt WARL, This is defined by the mtvt_mask
     *
     * tselect DBG_NUM_TRIGGERS, trigger_num
     *
     */
    {
        .name                = "CV32E40X",
        ...
        OPENHW_EXTENSION(OHWF_PMA16|OHWF_BUS_FAULT, OHRV_MASTER),
...

    {
        ...
        .trigger_num         = 1,           // number of implemented triggers
        .tinfo               = 0x00000004,  // tinfo default value
        .mcontext_undefined  = True,        // mcontext is not defined
        .scontext_undefined  = True,        // scontext is mot defined
        .mscontext_undefined = True,        // mscontext is mot defined
        .tcontrol_undefined  = False,       // tcontrol is mot undefined
        .mcontext_bits       = 0,           // implemented bits in mcontext
        .scontext_bits       = 0,           // implemented bits in scontext
        .no_hit              = True,        // tdata1.hit is unimplemented
        ...
        .restrictionsCB      = restrictCV32E40X,
        OPENHW_EXTENSION(OHWF_PMA16|OHWF_BUS_FAULT|OHWF_WARL_REJ, OHRV_DEV),
