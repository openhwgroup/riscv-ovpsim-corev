...
static const riscvConfig configList[] = {
    {
        ...
        OPENHW_EXTENSION(OHWF_NA, OHRV_V0_0_0),
    ...
    //
    {
        ...
        OPENHW_EXTENSION(OHWF_PMA16|OHWF_SEC, OHRV_V0_0_0),
...

    {
        ...
        // mcycle and minstret
        .instret_undefined   = True,        // instret CSR is undefined
        .cycle_undefined     = True,        // cycle CSR is undefined

        .time_undefined      = True,        // time CSR is undefined
        .PMP_undefined       = False,       // unimplimented PMP registers do not cause exceptions
        ...
        .restrictionsCB      = restrictCV32E40S,
        OPENHW_EXTENSION(OHWF_PMA16|OHWF_SEC|OHWF_BUS_FAULT|OHWF_PARITY_FAULT, OHRV_V0_2_0),
    ...
    //
    {
        .name                = "CV32E40X_V0.0.0",
        .arch                = RV32I|ISA_A|ISA_B|ISA_C|ISA_M|ISA_X,
        .archMask            = 0x0,         // misa is read-only
        .archFixed           = ~(ISA_A|ISA_B|ISA_X), // A,B,X controlled by parameter
        .user_version        = RVUV_2_3,    // User version 2.3
        .priv_version        = RVPV_1_11,   // Privileged version 1.11
        .dbg_version         = RVDBG_0_13_2,// Debug version 0.13.2
        ...
        OPENHW_EXTENSION(OHWF_PMA16|OHWF_BUS_FAULT, OHRV_V0_0_0),
    ...
    {
        .name                = "CV32E40X_V0.2.0",
        .arch                = RV32I|ISA_C|ISA_M,
        .archMask            = 0x0,         // misa is read-only
        .archFixed           = ~(ISA_A|ISA_B|ISA_M|ISA_X), // A,B,X controlled by parameter
        .user_version        = RVUV_2_3,    // User version 2.3
        .priv_version        = RVPV_1_12,   // Privileged version 1.11
        .dbg_version         = RVDBG_1_0_0, // Debug version 1.0.0
        .bitmanip_version    = RVBV_1_0_0,  // Bit Manipulation version 1.0.0
        .compress_version    = RVCV_0_70_1,
      //.compress_present    = (RVCS_Zca|RVCS_Zcb|RVCS_Zcmb|RVCS_Zcmp|RVCS_Zcmt),
        ...
        .restrictionsCB      = restrictCV32E40X,
        OPENHW_EXTENSION(OHWF_PMA16|OHWF_BUS_FAULT, OHRV_V0_2_0),
