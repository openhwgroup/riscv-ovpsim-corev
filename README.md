...
All four simulators are based on the Imperas CpuManager simulator base technology utilizing the OVP open standard APIs, and are targeted at different uses and have different capabilities.
...
For example on Linux:
         ...
         Info
         Info ---------------------------------------------------
         Info CPU 'riscvOVPsimCOREV/cpu' STATISTICS
...
Example coverage command:
        ...
        $ riscvOVPsimCOREV.exe --variant RVB32I --program eg.elf --cover basic --extensions I --reportfile impCov.log
